...
<div id="group_chat_dialog" class="main-content" title="Group Chat Window">
	...
	<div class="form-group" align="right">
		...
		<button type="button" name="send_group_chat" id="send_group_chat" class="btn btn-info"><button>
	</div>
</div>
</div>
</div>
...
$(document).ready(function(){
	...
	function make_chat_dialog_box(to_user_id, to_user_name)
	{
		...
		modal_content += '<textarea height="50px" name="chat_message_'+to_user_id+'" id="chat_message_'+to_user_id+'" class="form-control chat_message"></textarea>';
	...
	$(document).on('', '.start_chat', function(){
	...
	$(document).on('click', '.send_chat', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				window.location.replace("navbar.php");
		...
		if(chat_message == 'confirm'){
			$.ajax({
				...
				{
					//$('#chat_message_'+to_user_id).val('');
					window.location.replace("../chat/confirm_chat.php");
