<?php 
include 'traitement\inscription_driver.php'; ?>
<!doctype html>
<html lang="en">
    <head>
        <meta charset="utf-8" />
                ...
                <div class="card-body">
                    ...
                    <div id="basic-pills-wizard" class="twitter-bs-wizard">
                        <ul class="twitter-bs-wizard-nav">
                            ...
                            <li class="nav-item">
                                <a href="#Vehicle" class="nav-link" data-toggle="tab">
  ...
  <div>
    <form method="post" action="">
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="mb-3">
            <input type="text" class="form-control" name="code" id="basicpill-namecard-input" placeholder="Type code" value="<?php echo isset($phone) ? $code : ''; ?>">
...
<div class="tab-pane" id="Vehicle">
                                <div>
                                      <div class="row">
                                        ...
                                        <div class="alert alert-danger" role="alert">
                                            Although you may be able to skip this form, please note that your account will remain invalid until you complete it. We require this information to properly verify your identity and ensure the security of your account. By completing the form, you can help us to better protect your personal information and prevent any unauthorized access or use. We apologize for any inconvenience this may cause, but we appreciate your cooperation in helping us maintain the integrity of our systems.
                                        </div></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="basicpill-phoneno-input">Type Vehicle</label>
                                                <input type="text" class="form-control" id="basicpill-phoneno-input" name="type">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="basicpill-email-input">Capacite Vehicle</label>
                                                <input type="email" class="form-control" id="basicpill-email-input" name="capacite">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-3">
                                            <label for="formFile" class="form-label">Gray card</label>
                                            <input class="form-control" type="file" id="formFile" name="cart_evisite">
                                          </div>
                                          <div class="mb-3">
                                            <label for="formFile" class="form-label">Driven licence</label>
                                            <input class="form-control" type="file" id="formFile" name="drive_lic">
                                          </div>
                                    </div>
                                </div>
                              </div>-->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="text-center">
                                            ...
                                            <div>
                                                ...
                                                <input class="btn btn-danger" type="submit" name="Valider2" value="Confirme">
