<?php session_start();
        require_once('../classes/admin.php');
         ...
         $data=afficheradmin();
       if(isset($_SESSION['iduti']) || isset($_SESSION['client_id'])){
       }      
?>
<!doctype html>
<html lang="en">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                           ...
                           <!-- <li>
                            ...
                            <li>
                                <a href="chat_group.php" class=" waves-effect">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="true">
                                    ...
                                    <a href="calendar.html" class=" waves-effect">
                                        New Shipment</a>
                                    <a href="tracker_client.php" class=" waves-effect">Delivery Tracker
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="true">
                                    <li>
                                        <a href="calendar.html" class=" waves-effect">
                                            Account</a>
                                            <a href="message.php" class=" waves-effect">Contact</a>
